...
OMP_NUM_THREADS=1 ../parallelOpenMP/$algo $N_PARTICULE $T_FINAL > ./$dirname/log/log_$n_thread.log >&1
...
do
    OMP_NUM_THREADS=$n_thread ../parallelOpenMP/$algo $N_PARTICULE $T_FINAL > ./$dirname/log/log_$n_thread.log >&1
